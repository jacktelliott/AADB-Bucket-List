package com.jackelliott.bucketlist;
...
public class ThingsToDoActivity extends AppCompatActivity {
    ...
    private void setupList() {
        BucketListEntry[] thingsToDo = {
                ...
                new BucketListEntry("Experience the Northern Lights", "Somewhere in the artic circle, probably Norway.", R.drawable.northern_lights, 5),
                ...
                new BucketListEntry("Skydive", "Preferably somewhere with an amazing view", R.drawable.skydive, 3.5f)
        };
