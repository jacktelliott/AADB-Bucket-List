...
public class PlacesToGoActivity extends AppCompatActivity {
    ...
    private void setupList() {
        BucketListEntry[] placesToGo = {
                new BucketListEntry("Vietnam", "Con Dao Islands, Hanoi, Halong Way, Hoi An, Lang Co.", R.drawable.vietnam, 5),
                new BucketListEntry("Kerala, India", "Try varied tea flavours, stay in houseboad, the fabulous food!", R.drawable.kerala, 5),
